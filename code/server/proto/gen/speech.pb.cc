...
const uint32_t TableStruct_speech_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::lotso_im::SpeechRecognitionReq, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::lotso_im::SpeechRecognitionReq, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::lotso_im::SpeechRecognitionReq, _impl_.request_id_),
  PROTOBUF_FIELD_OFFSET(::lotso_im::SpeechRecognitionReq, _impl_.speech_content_),
  PROTOBUF_FIELD_OFFSET(::lotso_im::SpeechRecognitionReq, _impl_.user_id_),
  PROTOBUF_FIELD_OFFSET(::lotso_im::SpeechRecognitionReq, _impl_.session_id_),
  ~0u,
  ~0u,
  0,
  1,
  PROTOBUF_FIELD_OFFSET(::lotso_im::SpeechRecognitionRsp, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::lotso_im::SpeechRecognitionRsp, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::lotso_im::SpeechRecognitionRsp, _impl_.request_id_),
  PROTOBUF_FIELD_OFFSET(::lotso_im::SpeechRecognitionRsp, _impl_.success_),
  PROTOBUF_FIELD_OFFSET(::lotso_im::SpeechRecognitionRsp, _impl_.errmsg_),
  PROTOBUF_FIELD_OFFSET(::lotso_im::SpeechRecognitionRsp, _impl_.recognition_result_),
  ~0u,
  ~0u,
  0,
  1,
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 10, -1, sizeof(::lotso_im::SpeechRecognitionReq)},
  { 14, 24, -1, sizeof(::lotso_im::SpeechRecognitionRsp)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::lotso_im::_SpeechRecognitionReq_default_instance_._instance,
  &::lotso_im::_SpeechRecognitionRsp_default_instance_._instance,
};

const char descriptor_table_protodef_speech_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014speech.proto\022\010lotso_im\"\214\001\n\024SpeechRecog"
  "nitionReq\022\022\n\nrequest_id\030\001 \001(\t\022\026\n\016speech_"
  "content\030\002 \001(\014\022\024\n\007user_id\030\003 \001(\tH\000\210\001\001\022\027\n\ns"
  "ession_id\030\004 \001(\tH\001\210\001\001B\n\n\010_user_idB\r\n\013_ses"
  "sion_id\"\223\001\n\024SpeechRecognitionRsp\022\022\n\nrequ"
  "est_id\030\001 \001(\t\022\017\n\007success\030\002 \001(\010\022\023\n\006errmsg\030"
  "\003 \001(\tH\000\210\001\001\022\037\n\022recognition_result\030\004 \001(\tH\001"
  "\210\001\001B\t\n\007_errmsgB\025\n\023_recognition_result2d\n"
  "\rSpeechService\022S\n\021SpeechRecognition\022\036.lo"
  "tso_im.SpeechRecognitionReq\032\036.lotso_im.S"
  "peechRecognitionRspB\003\200\001\001b\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_speech_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_speech_2eproto = {
    false, false, 432, descriptor_table_protodef_speech_2eproto,
    "speech.proto",
...
SpeechRecognitionReq::SpeechRecognitionReq(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:lotso_im.SpeechRecognitionReq)
}
SpeechRecognitionReq::SpeechRecognitionReq(const SpeechRecognitionReq& from)
  ...
  // @@protoc_insertion_point(copy_constructor:lotso_im.SpeechRecognitionReq)
}
...
SpeechRecognitionReq::~SpeechRecognitionReq() {
  // @@protoc_insertion_point(destructor:lotso_im.SpeechRecognitionReq)
...
// @@protoc_insertion_point(message_clear_start:lotso_im.SpeechRecognitionReq)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "lotso_im.SpeechRecognitionReq.request_id"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "lotso_im.SpeechRecognitionReq.user_id"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "lotso_im.SpeechRecognitionReq.session_id"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* SpeechRecognitionReq::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:lotso_im.SpeechRecognitionReq)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_request_id().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "lotso_im.SpeechRecognitionReq.request_id");
  ...
  if (_internal_has_user_id()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "lotso_im.SpeechRecognitionReq.user_id");
    target = stream->WriteStringMaybeAliased(
  ...
  if (_internal_has_session_id()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "lotso_im.SpeechRecognitionReq.session_id");
    target = stream->WriteStringMaybeAliased(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:lotso_im.SpeechRecognitionReq)
  return target;
}

size_t SpeechRecognitionReq::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:lotso_im.SpeechRecognitionReq)
  size_t total_size = 0;
...
void SpeechRecognitionReq::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:lotso_im.SpeechRecognitionReq)
...
// @@protoc_insertion_point(class_specific_copy_from_start:lotso_im.SpeechRecognitionReq)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
SpeechRecognitionRsp::SpeechRecognitionRsp(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:lotso_im.SpeechRecognitionRsp)
}
SpeechRecognitionRsp::SpeechRecognitionRsp(const SpeechRecognitionRsp& from)
  ...
  // @@protoc_insertion_point(copy_constructor:lotso_im.SpeechRecognitionRsp)
}
...
SpeechRecognitionRsp::~SpeechRecognitionRsp() {
  // @@protoc_insertion_point(destructor:lotso_im.SpeechRecognitionRsp)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:lotso_im.SpeechRecognitionRsp)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "lotso_im.SpeechRecognitionRsp.request_id"));
        } else
          goto handle_unusual;
        continue;
      // bool success = 2;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "lotso_im.SpeechRecognitionRsp.errmsg"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "lotso_im.SpeechRecognitionRsp.recognition_result"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* SpeechRecognitionRsp::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:lotso_im.SpeechRecognitionRsp)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_request_id().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_request_id().data(), static_cast<int>(this->_internal_request_id().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "lotso_im.SpeechRecognitionRsp.request_id");
    target = stream->WriteStringMaybeAliased(
        1, this->_internal_request_id(), target);
  }
  ...
  if (_internal_has_errmsg()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "lotso_im.SpeechRecognitionRsp.errmsg");
    target = stream->WriteStringMaybeAliased(
  ...
  if (_internal_has_recognition_result()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "lotso_im.SpeechRecognitionRsp.recognition_result");
    target = stream->WriteStringMaybeAliased(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:lotso_im.SpeechRecognitionRsp)
  return target;
}

size_t SpeechRecognitionRsp::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:lotso_im.SpeechRecognitionRsp)
  size_t total_size = 0;
...
void SpeechRecognitionRsp::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:lotso_im.SpeechRecognitionRsp)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:lotso_im.SpeechRecognitionRsp)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void SpeechService::SpeechRecognition(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::lotso_im::SpeechRecognitionReq*,
                         ::lotso_im::SpeechRecognitionRsp*,
  ...
  switch(method->index()) {
    case 0:
      SpeechRecognition(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::lotso_im::SpeechRecognitionReq*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::lotso_im::SpeechRecognitionRsp*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& SpeechService::GetRequestPrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::lotso_im::SpeechRecognitionReq::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
const ::PROTOBUF_NAMESPACE_ID::Message& SpeechService::GetResponsePrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::lotso_im::SpeechRecognitionRsp::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
template<> PROTOBUF_NOINLINE ::lotso_im::SpeechRecognitionReq*
Arena::CreateMaybeMessage< ::lotso_im::SpeechRecognitionReq >(Arena* arena) {
  return Arena::CreateMessageInternal< ::lotso_im::SpeechRecognitionReq >(arena);
}
template<> PROTOBUF_NOINLINE ::lotso_im::SpeechRecognitionRsp*
Arena::CreateMaybeMessage< ::lotso_im::SpeechRecognitionRsp >(Arena* arena) {
  return Arena::CreateMessageInternal< ::lotso_im::SpeechRecognitionRsp >(arena);
}
